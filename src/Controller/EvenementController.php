...
use Symfony\Component\HttpFoundation\JsonEncoder;
use Symfony\Component\Serializer\Serializers;
...
class EvenementController extends AbstractController
{
    ...
    public function listevenementPDF(EvenementRepository $repositery): Response
    {
        ...
        foreach($evenements as $e){
            ...
            //$t->getImageTable()
            $file = $this->getParameter('brochures_directory') . '/' . $e->getImagee();
        ...
        $html = $this->renderView('evenement/listevenement.html.twig', [
            'evenements' => $evenements,"logo"=>$pngbase64,'listimge'=>$listimge,
        ]);
        // Load HTML to Dompdf
